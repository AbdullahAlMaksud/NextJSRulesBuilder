  ...
  const mainPanel = (() => {
    switch (activeTab) {
      case "structure":
        return <StructureTab />;
      case "packages":
        return <PackagesRulesTab config={packagesConfig} onChange={setPackagesConfig} />;
      case "naming":
      ...
      case "imports":
        return <ImportsTab config={config} newImportGroup={newImportGroup} setNewImportGroup={setNewImportGroup} update={update} />;
      case "testing":
        return <TestingTab config={config} update={update} />;
      case "performance":
        return <PerformanceTab config={config} update={update} />;
      case "custom":
        return <CustomRulesTab customRules={config.customRules} newRule={newRule} addRule={addRule} removeRule={removeRule} setNewRule={setNewRule} />;
      default:
